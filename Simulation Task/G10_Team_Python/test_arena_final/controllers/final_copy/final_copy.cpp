  ...
  while (robot->step(TIME_STEP) != -1)
  {
    untillWallFollow();
        ...
        // if (untillWallFollow()){
          ...
          // turnRobot(-5);
          // moveForward(15);
          // cout<<"move forward done"<<endl;
          // walltoChess();
          // cout<<"chess board arrived!"<<endl;
          // //pickRook();
            // kingPos();
            // chessBoard();
       // }
...
void wallFollow()
{
    ...
    sonarSensorValues[0]=sonarSensorValues[6]=sonarSensorValues[1]=sonarSensorValues[7]=sonarSensorValues[4]=sonarSensorValues[5]=0;
